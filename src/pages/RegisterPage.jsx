  ...
  return (
    <div className="min-h-[55vh] flex flex-col bg-[#f9e7f6]">
      ...
      >
        ...
        {/* Simulação do reCAPTCHA */}
        {/* <div className="mb-6 flex justify-center">
          <div className="bg-white border border-[#e5d3e9] rounded-lg p-4 w-full max-w-xs flex items-center justify-center">
            <span className="text-gray-500 text-sm">[reCAPTCHA aqui]</span>
          </div>
        </div> */}
        <button
          type="submit"
